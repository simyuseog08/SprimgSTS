...
<script type="text/javascript">
	$(function() {
		   if(${info.no>0}){
			  ...
			  $("i#s").text("확인");
			  $("input#no").attr("disabled","disabled");
		  } 
		$("button#submitPost").click(function() {
		/* 	if($(this).text()=='수정'){
				$("form").attr("action","modify.jsp")				
			}else if($(this).text()=='확인'){
				$("form").attr("action","insert.jsp")	
			} */
			if( $("i#s").text()=='수정'){
				 $("form").attr("action","modifyProcess.do");
			}
				$("form[name='writerFrm']").submit();
		});
	});
...
<body>
	...
	<form action="Writer.do" method="post" name="writerFrm" enctype="multipart/form-data">
	<div id="write-field">
		...
		<div class="col-md-6">
						...
						<div class="row row-xs-bskr">
							<div class="col-md-6 col-sm-6 col-xs-bskr">
								...
								<div class="input-forms">
									<input size="20" type="text" name="name" value="${info.name}"
							...
							<div class="col-md-6 col-sm-6 col-xs-bskr">
								...
								<div class="input-forms">
									<input size="20" type="password" name="pw" value="${info.pw}"
			...
			<div class="form-group">
				<table>
					<tr>
						...
						<td calss="td2"><textarea name="textarea" class="form-control col-sm-5"
								rows="20">${info.textarea}</textarea></td>
					</tr>
					<tr>
					<td class="td1"></td>
			...
			<div class="bottombox">
				...
				<button id="submitPost" type="submit" class="btn btn-primary btn-sm">
					<i class="glyphicon glyphicon-ok" id="s"></i>
				</button>
			</div>
		</div>
	</div>
